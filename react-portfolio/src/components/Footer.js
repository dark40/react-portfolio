    ...
    return (
        <footer className='d-flex flex-wrap justify-content-center align-items-center py-3 my-4 border-top'>
            <ul className='nav col-md-4 justify-content-center list-unstyled d-flex'>
                ...
                {/* Github */}
                <li className='ms-3'>
                    <a className='text-muted' href='https://github.com/dark40'>
                ...
                {/* Linkedin */}
                <li className='ms-3'>
                    <a className='text-muted' href='https://www.linkedin.com/in/freddie-yang/'>
                ...
                {/* Spotify*/}
                <li className='ms-3'>
                    <a className='text-muted' href='https://open.spotify.com/user/222h4ulswh2ngyslvv2bgjtra'>
